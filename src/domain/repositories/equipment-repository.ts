...
export type EquipmentRepository = {
  findEquipments: (dto: FindEquipmentsDTO) => Promise<Result<EquipmentWithLocation[]>>;
  findOneEquipment: (dto: FindOneEquipmentDTO) => Promise<Result<EquipmentWithLocation>>;
